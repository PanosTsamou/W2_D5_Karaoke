...
class KaraokeTest(unittest.TestCase):
    ...
    def setUp(self):
        self.guest_1 = Guest("Paul", 32, 40, "Tennessee Whiskey", 2)
        ...
        self.karaoke_venue = Karaoke([self.room_1, self.room_2, self.room_3], 800)
    ...
    def test_check_out_guest1(self):
        ...
        self.assertEqual(0,self.booking_guest_1.guest.wallet)
